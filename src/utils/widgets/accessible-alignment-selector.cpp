...
#include "accessible-alignment-selector.hpp"
...
QString AccessibleAlignmentSelector::text(QAccessible::Text textType) const
{
	if (textType == QAccessible::Name) {
		...
		if (str.isEmpty()) {
			str = QString::fromUtf8(obs_frontend_get_locale_string("Accessible.Widget.Name.AlignmentSelector"));
		}
		return str;
	}
...
QVariant AccessibleAlignmentSelector::value() const
{
	...
	return QString::fromUtf8(obs_frontend_get_locale_string("None"));
}
